...
class TaggerService(Service):
    ...
    def predict(self, tokens, **kwargs):
        ...
        return self.format_output(outcomes, tokens_batch=tokens_batch, label_field=label_field, vectorized_examples=examples, valid_labels_only=valid_labels_only)

    def format_output(self, predicted, tokens_batch=None, label_field='label', vectorized_examples=None, valid_labels_only=True, **kwargs):
