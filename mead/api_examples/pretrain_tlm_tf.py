...
def main():
    ...
    parser.add_argument("--reload_npz", type=str, help="Option allows you to restart from an NPZ.  Any optim or state info is lost")
    ...
    timer = Timer()
    with strategy.scope():
        needs_reload = args.reload_npz is not None
