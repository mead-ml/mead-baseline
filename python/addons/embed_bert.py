...
def model_fn(input_ids, input_mask, input_type_ids, bert_config, init_checkpoint,
             use_one_hot_embeddings):  # pylint: disable=unused-argument
    model = BertModel(
        config=bert_config,
        is_training=False,
        input_ids=input_ids,
...
class BERTEmbeddings(TensorFlowEmbeddings):
    ...
    def encode(self, x=None):
        ...
        all_layers = model_fn(input_ids=self.x,
                              input_mask=input_mask,
