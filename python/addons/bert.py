...
class BERTModel(TensorFlowEmbeddings):
...
class BERTEmbeddings(BERTModel):
    ...
    def __init__(self, name, **kwargs):
        super(BERTEmbeddings, self).__init__(name, **kwargs)
...
class BERTPooling(BERTModel):


    def __init__(self, name, **kwargs):
        super(BERTPooling, self).__init__(name, **kwargs)
