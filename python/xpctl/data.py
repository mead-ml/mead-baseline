...
class ExperimentGroup(object):
    ...
    def reduce(self, aggregate_fns):
        ...
        data = {}
        for prop_value, resultset in self.grouped_experiments.items():
        ...
        aggregate_resultset = AggregateSet(data=[])
        for prop_value in data:
            ...
            for metric in data[prop_value]:
                ...
                agr = deepcopy(Aggregate(metric=metric, values=values, **d))
