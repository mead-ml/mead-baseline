...
def create(embeddings, nc, filtsz, cmotsz, hsz, maxlen, pdrop):
    ...
    lut = Embedding(input_dim=vocab_size, output_dim=embedding_dim, weights=[embeddings.weights], input_length=maxlen)
...
print('=====================================================')
model = load_model('%s/cnn-sentence-fine.model' % args.outdir)
